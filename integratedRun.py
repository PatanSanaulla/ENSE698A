...
ALL_PATHS = dict()
TARGET_POINTS = []
OBJECTS_LIST = ["-4.301942795144567100e+01 1.668216601234799512e+01",
                "-3.903965686868058071e+01 3.878300354844295139e+00",
                "-3.596882883644629914e+01 -1.925359988963654345e+01",
                "-2.779374694923166089e+01 -6.786084238198500707e+00",
                "-3.571816138295204723e+01 3.494265815045015700e+01",
                "-3.274305282709623555e+01 3.527596906749624139e+01",
                "-3.273008800231556847e+01 3.526363670854166088e+01",
                "-2.280438795227334836e+01 3.061318893123140938e+01",
                "-1.766011883552472739e+01 1.485091621136611373e+01",
                "-1.745021714791523948e+01 1.572756443608808574e+01",
                "-1.762746734797226367e+01 1.500315160025669137e+01",
                "-1.365122833879108200e+01 3.194807128906250071e+00",
                "-2.128056850333196692e+01 3.194807128906250071e+00",
                "-1.416444155733705657e+01 -3.831263618950078165e+00",
                "-1.416795748296407353e+01 -3.996696249250648592e+00",
                "-8.889802254166550455e+00 -1.646985904062735173e+01",
                "-8.863012412951995600e+00 -1.660381190694694098e+01",
                "-7.915420401983931598e+00 3.168938626365390832e+01",
                "7.011463087285690676e+00 2.103207979694845520e+01",
                "2.388495074492705594e+00 3.929433142321048233e+00",
                "1.299595617362090572e+01 -2.783283076362472030e+01",
                "3.085184920661876973e+01 -3.675865612396758131e-01",
                "3.019226145403777650e+01 -2.287676242565955675e+01",
                "3.020265316122621613e+01 -2.287676800407635014e+01"]
OBJS_clustered = []
COLLECTED_OBJECTS = []
...
def orientGroundAgent(x, y):
    # import perception
    perception.fetchVSDataAndOrient(clientID, x, y)
...
if clientID != -1:
    ...
    while len(OBJECTS_LIST) != len(COLLECTED_OBJECTS):
        ...
        vrep.simxAddStatusbarMessage(clientID, 'Reached the object ' + str(len(COLLECTED_OBJECTS)) + '!!',
